...
class MultiSelectDialogField<V> extends FormField<List<V>> {
  ...
  final bool loading;
  final Widget Function(Widget Function(MultiSelectItem<V> Function(List<MultiSelectItem<V>>) itemCallback) builder)? customBuilder;
...
class _MultiSelectDialogFieldView<V> extends StatefulWidget {
  ...
  _MultiSelectDialogFieldView._withState(_MultiSelectDialogFieldView<V> field, FormFieldState<List<V>> this.state)
      : items = field.items,
        title = field.title,
        loading = field.loading,
        buttonText = field.buttonText,
        buttonIcon = field.buttonIcon,
        customBuilder = field.customBuilder,
    ...
    if (widget.chipDisplay != null) {
      ...
      if (widget.chipDisplay!.disabled!) {
        ...
        return MultiSelectChipDisplay<V>(
          ...
          onTap: (item) {
            List<V>? newValues = _selectedItems;
