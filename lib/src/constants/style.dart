...
import 'package:flutter_base/src/constants/font.dart';
import 'color.dart';
import 'dimens.dart';
...
class CStyle {
  ...
  /// FontSize 20.0
  static TextStyle headline3({TextStyle? style}) => TextStyle(
        color: CColor.textDark1,
  ...
  /// FontSize 16.0
  static TextStyle headline4({TextStyle? style}) => TextStyle(
        fontFamily: AppFont.robotoRegular,
        height: 1.25,
        color: CColor.textDark1,
  ...
  /// FontSize 14.0
  static TextStyle paragraph1({TextStyle? style}) => TextStyle(
        fontFamily: AppFont.robotoRegular,
        color: CColor.neutral1,
        fontSize: CFontSize.paragraph1,
        height: 1.14285714286,
        // in css: Line height = 16
        fontWeight: FontWeight.w400,
      ).merge(style);

  /// FontSize 13.0
  static TextStyle paragraph2({TextStyle? style}) => TextStyle(
        fontFamily: AppFont.robotoRegular,
        color: CColor.neutral1,
  ...
  /// FontSize 12.0
  static TextStyle paragraph3({TextStyle? style}) => TextStyle(
        fontFamily: AppFont.robotoRegular,
        color: CColor.neutral1,
  ...
  /// FontSize 10.0
  static TextStyle paragraph4({TextStyle? style}) => TextStyle(
        fontFamily: AppFont.robotoRegular,
        color: CColor.neutral1,
  ...
  /// FontSize 8.0
  static TextStyle paragraph5({TextStyle? style}) => TextStyle(
        fontFamily: AppFont.robotoRegular,
        color: CColor.neutral1,
